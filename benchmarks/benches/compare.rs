    ...
    fn five_cards(bencher: divan::Bencher) {
        ...
        bencher
            ...
            .with_inputs(|| {
                let cards = rng
                    .borrow_mut()
                    .choose_multiple(ckc_rs::deck::POKER_DECK.arr().iter().copied(), 5);
    ...
    fn seven_cards(bencher: divan::Bencher) {
        ...
        bencher
            ...
            .with_inputs(|| {
                let cards = rng
                    .borrow_mut()
                    .choose_multiple(ckc_rs::deck::POKER_DECK.arr().iter().copied(), 7);
...
fn poker<const N: usize>(bencher: divan::Bencher) {
    ...
    bencher
        .counter(divan::counter::ItemsCount::new(1u32))
        .with_inputs(|| {
            poker::Card::generate_shuffled_deck()
                .drain(..N)
                .collect::<Vec<_>>()
        })
        .bench_local_refs(|hand| poker_eval.evaluate(hand).unwrap())
}
...
fn rust_poker<const N: usize>(bencher: divan::Bencher) {
    ...
    bencher
        ...
        .with_inputs(|| {
            ...
            rng.borrow_mut().shuffle(&mut deck);
            deck[..N].to_vec()
        })
        .bench_local_refs(|cards| {
